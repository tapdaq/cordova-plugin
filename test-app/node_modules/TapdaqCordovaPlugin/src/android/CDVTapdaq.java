...
public class CDVTapdaq extends CordovaPlugin {
    ...
    static TMBannerAdView banner = null;
                ...
                if(adType != null){
                    ...
                    switch(type){
                        ...
                        case AdTypeMoreApps : 
                            ...
                            break; 
                        case AdTypeBanner : 
                            res = banner != null && banner.isReady();
                            break;  							
                        default: 
    ...
    {
        banner = new TMBannerAdView(cordova.getActivity());
    }
     ...
     */
    private void showBanner(final String position) {
        if(banner == null){
            return;
        }
        ...
        cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                ...
                layoutParams.gravity = TapdaqHelper.GetBannerGravityFromString(position);
    ...
    private void loadBanner (String bannerAdType, TMAdListener listener) {
        ...
        banner.load(cordova.getActivity(), bannerAdSizes, listener);
    }
