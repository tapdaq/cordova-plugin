...
var app = {
    ...
    onDeviceReady: function () { 
            ...
            enabledPlacements: [
                 {
                    ...
                    position: Ad.AdBannerPositions.TOP,
                    tags: []
                },{
        ...
        loadBannerBtn.on("click", function (e) {
            ...
            Tapdaq.loadAd(Ad.AdTypes.BANNER, Ad.AdBannerPositions.TOP, size); // alternative way to load Ad
        ...
        showBannerBtn.on("click", function (e) {
             Tapdaq.showAd(Ad.AdTypes.BANNER, Ad.AdBannerPositions.TOP);
        ...
        hideBannerBtn.on("click", function (e) {
             Tapdaq.hideBanner(Ad.AdBannerPositions.TOP);
